...
class AppStore extends Component {
  ...
  getFilteredProjects = () => {
    ...
    const filteredProjectsList = appsList.filter(
      eachApp =>
  ...
  render() {
    ...
    return (
      <div className="app-container">
        ...
        <div>
          <ul className="app-cards-container">
            {filteredProjects.map(eachImage => (
              <AppItem key={eachImage.appId} appDetails={eachImage} />
            ))}
          </ul>
        </div>
      </div>
